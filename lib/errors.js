...
export function friendlyError(err) {
  ...
  switch (err.status) {
    case 401:
      if (err.code === 'login') return 'Inicia sesión para generar.';
    ...
    case 403:
      if (err.code === 'private') return 'Esta app es privada por ahora. Pide acceso al administrador.';
      return 'No tienes créditos suficientes en Higgsfield. Recarga en console.higgsfield.ai.';
