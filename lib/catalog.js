...
export const STUDIOS = [
  { id: 'explore', label: 'Explorar', kicker: '00', blurb: 'Todos tus modelos y creaciones en un vistazo.' },
  { id: 'image', label: 'Imagen', kicker: '01', blurb: 'Retratos, producto, carteles y edición con referencias.' },
  { id: 'video', label: 'Video', kicker: '02', blurb: 'Texto, imagen o referencias a video, con audio nativo.' },
  { id: 'transform', label: 'Transformar', kicker: '03', blurb: 'Edita, extiende o transfiere movimiento a un video existente.' },
  { id: 'characters', label: 'Personajes', kicker: '04', blurb: 'Entrena un Soul ID con tus fotos y úsalo en SOUL.' },
  { id: 'prompts', label: 'Prompts', kicker: '05', blurb: 'Más de 1.500 prompts listos para usar.' },
];
